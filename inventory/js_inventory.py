...
#jecoulte - commenting this out to clean up # of created groups
...
#jecoulte adding this for non-public instances, must be accessed via bastion host
#  set in ssh.cfg
    if server['interface_ip'] == "" and 'private_v4' in server :
        hostvars[key]['ansible_ssh_host'] = server['private_v4']
        hostvars[key]['ansible_host'] = server['private_v4']
